            ...
            <div className='w-[90%] md:w-[80%] mx-auto items-center grid grid-cols-1 xl:grid-cols-2 gap-10'>
                ...
                <div>
                    ...
                    <p className='text-xs sm:text-sm md:text-base font-medium text-gray-300'>
                        Sit back,  relax and prepare to experience a new level of audio excellence. These headphones cobine cutting edge technology with the finest craftmanship, for the ultimate listening experience.
                    </p>
                    {/* Buttons */}
                    <div className='mt-8 flex flex-col sm:flex-row w-fit sm:items-center space-y-4 sm:space-y-0 sm:space-x-4'>
                        {/* 1st button */}
                        <a href="#_" className="relative overflow-hidden px-10 py-3 font-medium text-white transition duration-300 bg-blue-400 rounded-md hover:bg-blue-500 ease">
